/*CHALLENGE 02 - If the user sets the tries higher than 5, increase the guessing range from 10 to 100.*/
package main
import (
...
func main() {
    ...
    fmt.Scanln(&tries)
    if (tries > 5){
	        secretNumber = randomizer.Intn(100)  // generate numbers between 0 and 10 only
    ...
    for try := 1; try <= tries; try++ {
        ...
        // Declare and Initialize ‘ := ‘ you declare and assign a value upon declaration. Go will automd] 0:vim
