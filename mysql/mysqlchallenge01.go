/*
CHALLENGE 01 - Rewrite the last program so that the input (myid) is defined by an argument read in from the CLI. Name your program, ~/mysql/mysqlchallenge01.go Hint: Use the "flag" package to prevent conversion issues.
